...
if st.session_state.df is not None :
    with st.form("Setup"): 
        ...
        with col_1 : 
            ...
            "Using a K-Nearest Neighbors approach" :  "knn" , 
            "Impute with provided numerical value" : "int or float"
            }
            st.write()
            ...
            if choice == "Impute with provided numerical value" :
                ...
                if type_num == "Int" :
                    ...
                    num_imputation = float(st.number_input("Int"))
        with col_2 : 
            ...
            "Drop rows containing missing values" : "drop" ,
            "Most frequent value" :"mode" ,
            "Impute with provided string" : "str"
            } 
            choice = st.selectbox("Choose a method", dic.values())
